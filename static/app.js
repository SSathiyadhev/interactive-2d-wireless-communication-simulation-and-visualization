...
function getAbsorbingLayerThickness() {
  return latestTelemetry?.absorbing_layer_thickness ?? 2.0;
}

function getComputationalWidth() {
  return latestTelemetry?.computational_width
    ?? (SIM_WIDTH + 2.0 * getAbsorbingLayerThickness());
}

function getComputationalHeight() {
  return latestTelemetry?.computational_height
    ?? (SIM_HEIGHT + 2.0 * getAbsorbingLayerThickness());
}
